    ...
    <section class="content">
                        ...
                        <div class="card-body">
                            <form class="form-horizontal" action="" method="post">
                              <?php  
                                    ...
                                    $id = $_GET['id_mhs'];
                                    $q = mysqli_query($conn, "SELECT * FROM tb_mhs where id_mhs ='$id'");
                              ...
                              <div class="form-group row">
                                  ...
                                  <input type="text" class="form-control" id="inputEmail3" name="npm" value="<?= $m['npm'] ?>">
                                  </div>
                              </div>
                              <div class="form-group row">
                                  <label for="inputEmail3" class="col-sm-2 col-form-label">Nama Mahasiswa</label>
                                  <div class="col-sm-10">
                                  <input type="text" name="nama" value="<?= $m['nama'] ?>" class="form-control" id="inputEmail3">
                                  </div>
                              </div>
        ...
        <?php 
            if(isset($_POST['kirim'])) {
              ...
              $query = mysqli_query($conn, "UPDATE tb_mhs SET id_mhs='$id_mhs', npm='$npm', nama='$nama' where id_mhs='$id_mhs'");
              if($query)
              {
                  echo "<script>
